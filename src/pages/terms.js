                    ...
                    <div className="md:flex justify-center">
                        <div className="md:w-3/4">
                            <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                                ...
                                <div className="mt-6">
                                    <Link2 to="#" className="btn bg-green-600 hover:bg-green-700 text-white rounded-md">Accept</Link2>
                                    <Link2 to="#" className="btn bg-transparent hover:bg-green-600 border border-green-600 text-green-600 hover:text-white rounded-md ms-2">Decline</Link2>
                                </div>
                            </div>
                        </div>
                    </div>
