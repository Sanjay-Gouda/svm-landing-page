...
import {CgTrees, BiShieldAlt2,GoRocket, BsCheckCircle} from "../assets/icons/vander"
                ...
                <div className="container">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-[30px] gap-y-[50px]">
                        {pricing.map((item,index)=>{
                            ...
                            return(
                                <div key={index} className="rounded-md shadow dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 duration-500 ease-in-out">
